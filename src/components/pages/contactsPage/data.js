...
import Valerockk from "../../../img/ourTeam/ValeriiTroian.jpg";
const contacts = {
  en: [
    {
      name: "Ivan Ilchenko",
      ...
      tasks:
        "I was Scrum Master in this project. I've developed header, logo, modal window for navigation, responsive and adaptive design.",
